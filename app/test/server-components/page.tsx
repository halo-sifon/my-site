  ...
  return (
    <div className="flex flex-col min-h-screen p-8">
      <div className="max-w-4xl mx-auto w-full">
        <h1 className="text-display-md mb-6">服务器组件测试</h1>

        <div className="mb-4 p-4 rounded bg-canvas-soft dark:bg-primary">
        ...
        <div className="space-y-4">
          {filteredContent.length === 0 ? (
            ...
            filteredContent.map(item => (
              <div
                key={item.id}
                className="p-4 rounded-sm border border-hairline"
              >
                <h2 className="text-display-sm mb-3">{item.title}</h2>
        ...
        <div className="mt-8">
          <a href="/test" className="btn-secondary inline-block">
            ← 返回测试中心
          </a>
        </div>
      </div>
